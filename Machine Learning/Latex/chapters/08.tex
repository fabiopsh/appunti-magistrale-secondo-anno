...
\begin{boxnote}{Anteprima del progetto}

Gruppi di 2--3 persone. \textbf{Tipo A}: realizzare un simulatore di
rete neurale e applicarlo (linguaggio libero). \textbf{Tipo B}:
applicazioni sperimentali estese con simulatori esistenti, confrontando
più modelli (NN, SVM, K-NN\ldots). Entrambi partecipano alla
competizione \textbf{ML-CUP}. Consegna circa 10--14 giorni lavorativi
prima dell'orale.
